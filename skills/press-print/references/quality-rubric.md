...
When the source hierarchy is diffuse, repetitive, sparse, or ambiguous, evaluate whether Matter actively formed a stronger hierarchy rather than inheriting the weakness.
